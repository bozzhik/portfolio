...
const Badge: React.FC<Props> = ({icon, href, text, className}) => {
  return (
    <Link href={href} className={cn('group inline-flex items-center rounded border p-1 text-sm leading-4 no-underline border-neutral-700 bg-custom-gray text-neutral-100', className)}>
