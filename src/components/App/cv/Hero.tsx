  ...
  return (
    <section data-section="hero-cv">
      <div className="space-y-3">
        ...
        <Text>
          I&#39;m a website developer and user interface designer. Currently, I work as a self-employed frontend developer, specializing in creating impressive websites that boost business.
